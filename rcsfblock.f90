...
!-----------------------------------------------
      ...
      CHARACTER*300 cl1, cl2, cl3
      CHARACTER*300 pl1, pl2, pl3
...
! Write the orbitals that have been found in the CSFs
      ...
      DO ii = nblock, 1, -1
         ...
         iunit = 6000 + idx
         REWIND (iunit)
         READ (iunit, '(A)', END = 9999) cl1
         READ (iunit, '(A)', END = 9999) cl2
         READ (iunit, '(A)', END = 9999) cl3
         WRITE (19,'(A)') TRIM(cl1)
         WRITE (19,'(A)') TRIM(cl2)
         WRITE (19,'(A)') TRIM(cl3)
         pl1=cl1
  ...
  200    READ (iunit, '(A)', END = 9999) cl1
         ...
         WRITE (19,'(A)') TRIM(cl2)
         WRITE (19,'(A)') TRIM(cl3)
         elseif(cl2.ne.pl2)then
         WRITE (19,'(A)') TRIM(cl2)
         WRITE (19,'(A)') TRIM(cl3)
         elseif(cl3.ne.pl3)then
         WRITE (19,'(A)') TRIM(cl3)
         endif
         pl1=cl1
         pl2=cl2
